...
KEYWORDS = [
    ...
    "en fait", "vraiment", "très puissant", "reellement", "impressionnant", "excellent", "ce moment", "essentiel", "Argent", "Business", "ensuite", "second temps", "premierement", "danger", "secret", "fou", "dingue", "d’ailleurs"
]
...
def main():
    ...
    cut_video_clips(VIDEO_INPUT, best, OUTPUT_DIR)
